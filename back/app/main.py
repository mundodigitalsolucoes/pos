...
def create_public_satisfecho_delivery_order(
    ...
    """Legacy public URL; use the same validated catalog checkout as the current UI."""
    from .catalog_modifier_checkout_routes import create_public_catalog_checkout_impl
