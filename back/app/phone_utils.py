...
def normalize_phone_to_e164(phone: str, default_country: str = "BR") -> str | None:
    """
    Normalize a phone number to E.164 format (e.g. +5517991886725).
    ...
    if len(digits_only) < 8:
        return None
    country_upper = (default_country or "BR").upper()[:2]
    prefix = _COUNTRY_CODES.get(country_upper, "55")
