...
import { LoyaltySettingsComponent } from '../settings/loyalty-settings.component';

@Component({
  selector: 'app-loyalty-page',
  standalone: true,
  imports: [SidebarComponent, LoyaltySettingsComponent],
  template: `
    <app-sidebar>
      <main class="commercial-page">
        <header class="commercial-header">
          ...
          <h1>Fidelidade</h1>
          <p>Configure o programa de fidelidade e acompanhe os clientes participantes.</p>
        </header>
  ...
  styles: [`
    ...
    @media (max-width: 720px) { .commercial-page { padding: 1rem; } .commercial-card { padding: 1rem; } }
  `],
})
