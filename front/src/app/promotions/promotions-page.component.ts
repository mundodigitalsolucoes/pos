...
import { PromoSettingsComponent } from '../settings/promo-settings.component';

@Component({
  selector: 'app-promotions-page',
  standalone: true,
  imports: [SidebarComponent, PromoSettingsComponent],
  template: `
    <app-sidebar>
      <main class="commercial-page">
        <header class="commercial-header">
          ...
          <p>Crie e acompanhe promoções aplicadas aos canais de venda do restaurante.</p>
        </header>
